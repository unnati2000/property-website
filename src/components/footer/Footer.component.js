    ...
    <div className={classes.footer}>
      <Grid spacing={2} container>
        ...
        <Grid md={2} item>
          ...
          <Box mt={1}>
            <Typography>
              <Link className={classes.links}>Budget</Link>
            </Typography>
            <Typography>
              <Link className={classes.links}>Luxury</Link>
            </Typography>
            <Typography>
              <Link className={classes.links}>Villa</Link>
            </Typography>
            <Typography>
              <Link className={classes.links}>Plots</Link>
            </Typography>
            <Typography>
              <Link className={classes.links}>Farm house</Link>
            </Typography>
          </Box>
        </Grid>
        <Grid md={4} item>
